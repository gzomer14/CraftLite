...
const BASE_SOUNDS: Record<string, Recipe> = {
  ...
  // M14: a boia caindo e o peixe mordendo — o som que manda puxar.
  'fishing/splash': { kind: 'noise', duration: 0.22, color: 'pink', gain: 0.32, attack: 0.004, decay: 0.2, filter: 'bandpass', freq: 900, freqTo: 380, q: 0.9 },
